...
export function HeaderClient({ header }: Props) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 dark:bg-background/95 backdrop-blur-sm border-b border-gray-100 dark:border-border">
      {/* Announcement Bar */}
        ...
        >
          <div className="relative">
            <input
              ...
              className="w-full rounded-pill border border-gray-200 dark:border-border pl-12 pr-4 py-3 text-sm bg-white dark:bg-card focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
            />
